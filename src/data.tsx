...
export const work_data = [
  {
    ...
    description:
      "My focus at CausaLens, alongside sourcing ad hoc data, was aiding the development of novel software to aid the provision of data and creation and maintenance of data pipelines for users. This involved the use of multiple proprietary frameworks, Graph Databases, SQLAlchemy/SQL Databases, FastAPI, and Docker for containerisation of various microservices.",
    date: "2022",
    dateLabel: "6M",
    tags: [
      "Python",
...
export const education_data = [
  {
    ...
    description:
      "Oculus Go Virtual Reality experience educating users on Parkinson's Disease produced for my Master's Thesis.",
    date: "2018-19",
    dateLabel: "18M",
  ...
  },
  {
    ...
    subtitle: "University of Bristol, UK",
    description:
      "Experimental computational neuroscience project analysing EEG for my final dissertation.",
    date: "2015-18",
    dateLabel: "3Yrs",
    tags: ["Matlab", "SPSS"],
  },
